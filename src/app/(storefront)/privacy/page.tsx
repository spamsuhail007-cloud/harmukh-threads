  ...
  return (
    <div className="container" style={{ padding: 'var(--space-3xl) 0', maxWidth: '800px' }}>
      ...
      <div style={{ lineHeight: 1.8, color: 'var(--on-surface)', display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
        ...
        <h3>6. Contact Us</h3>
        <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by email at <strong>harmukhthreads@gmail.com</strong> or via phone at <strong>+91 84910 06127</strong>.</p>
      </div>
    </div>
  );
}
